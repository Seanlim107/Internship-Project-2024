...
#yolo.py file referenced from https://github.com/skhadem/3D-BoundingBox
...
class my_Yolo:
    ...
    def __init__(self, yolo_path, confidence=0.5, threshold=0.3):
        ...
        weights_path = os.path.join('runs/detect/train7/weights/best.pt')
        # cfg_path = os.path.sep.join([yolo_path, "yolov3.cfg"])

        self.net = YOLOv10(weights_path)
